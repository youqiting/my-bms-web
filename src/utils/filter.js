...
/* 拼接图片 */
Vue.filter('picSrc', (value, imgHttp = SystemConst.image.domain) => {
    return imgHttp + (value && value[0]=="/"?"":"/")+ value;
})

Vue.filter('digit', (value, digitNum = 2) => {
    return Number(value).toFixed(digitNum);
})